...
@Component({
  selector: 'app-qa-suspicious-listing',
  templateUrl: './qa-suspicious-listing.component.html',
  styleUrls: ['./qa-suspicious-listing.component.scss']
})
export class QaSuspiciousListingComponent implements OnInit {
  userRole = UserRole;
...
getSuspiciousOrderListingData() {
  ...
  this.qaService.getSuspiciousOrderListingData(tempUrlQuery).subscribe(
    response => {
